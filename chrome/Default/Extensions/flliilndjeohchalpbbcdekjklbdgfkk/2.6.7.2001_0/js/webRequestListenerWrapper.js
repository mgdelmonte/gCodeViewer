...
function singleRedirect(event) {
  var lastRedirectedRequestId = -1;
  var originalAddListener = event.addListener.bind(event); // eslint-disable-next-line no-param-reassign
  ...
  event.addListener = function (handler) {
    ...
    originalAddListener.apply(void 0, [function (details) {
      var result = handler(details);
...
},{"core-js/modules/es6.function.bind":21}]},{},[22]);
