...
},{"./_array-methods":12,"./_export":24,"./_strict-method":65}],80:[function(require,module,exports){
'use strict';
var ctx = require('./_ctx');
var $export = require('./_export');
var toObject = require('./_to-object');
...
},{"@babel/runtime/helpers/interopRequireDefault":5,"@babel/runtime/helpers/typeof":6,"background/localStorage":1,"configuration":98,"underscore":95}],98:[function(require,module,exports){
module.exports={
...
$(function () {
  ...
  config.languages.forEach(function (language) {
    $input.append("<option value=\"".concat(language, "\">").concat(language, "</option>"));
  });
  locale.retrieve(function (language) {
    $input.val(language);
    $input.on('change', function () {
      return locale.store($input.val());
    });
  });
  messenger.publish('ABTestDecider:getParams', {}, function (data) {
    $('#ab-params').val(JSON.stringify(data, null, 2));
  });
});
},{"Locale":96,"config":97,"content/messagingInterface":100,"core-js/modules/es6.array.for-each":79,"core-js/modules/web.dom.iterable":88,"jquery":"jquery"}],100:[function(require,module,exports){
"use strict";
